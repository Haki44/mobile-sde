  ...
  <div>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col">
      <div class="w-full flex justify-end">
        <router-link to="/admin/period/create" class="text-center bg-blue-600 text-white p-2 rounded w-36 mr-5 mb-5">Create Period</router-link>
      </div>
