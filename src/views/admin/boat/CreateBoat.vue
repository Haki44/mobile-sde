<template>
  <div>
    ...
    <div class="p-5">
      <form @submit="storeBoat" enctype="multipart/form-data">
        <div class="relative z-0 mb-6 w-full group">
            <input type="text" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.name" required />
        ...
        <div class="mt-5 relative z-0 mb-6 w-full group">
            <textarea id="description" rows="4" v-model="boat.description_en" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"></textarea>
        ...
        <div class="relative z-0 mb-6 w-full group">
            <input type="text" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.type_fr" required />
        ...
        <div class="relative z-0 mb-6 w-full group">
            <input type="text" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.type_en" required />
        ...
        <div class="relative z-0 mb-6 w-full group">
            <input type="number" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.displacements" required />
        ...
        <div class="relative z-0 mb-6 w-full group">
            <input type="number" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.surface" required />
        ...
        <div class="relative z-0 mb-6 w-full group">
            <input type="number" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.engine_power" required />
        ...
        <div class="flex flex-row">
          ...
          <div class="basis-1/2 mr-5">
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" name="start_date" id="start_date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.hull_fr" required />
          ...
          <div class="basis-1/2">
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" name="end_date" id="end_date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.hull_en" required />
        ...
        <div class="flex flex-row">
          ...
          <div class="basis-1/2 mr-5">
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" name="start_date" id="start_date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.deck_fr" required />
          ...
          <div class="basis-1/2">
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" name="end_date" id="end_date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.deck_en" required />
        ...
        <div class="flex flex-row">
          ...
          <div class="basis-1/2 mr-5">
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" name="start_date" id="start_date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.mast_fr" required />
          ...
          <div class="basis-1/2">
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" name="end_date" id="end_date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.mast_en" required />
        ...
        <div class="relative z-0 mb-6 w-full group">
            <input type="text" name="name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="boat.architect" required />
        ...
        <div class="mt-5 relative z-0 mb-6 w-full group">
            <textarea id="description" rows="4" v-model="boat.diverse_fr" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"></textarea>
        ...
        <div class="mt-5 relative z-0 mb-6 w-full group">
            <textarea id="description" rows="4" v-model="boat.diverse_en" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"></textarea>
        ...
        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">create Boat</button>
      </form>      
    </div>
...
export default {
  ...
  methods: {
    ...
    async storeBoat(e){
      ...
      let boatItem = { name: this.boat.name, picture: this.boat.file, description_fr: this.boat.description_fr, description_en: this.boat.description_en,type_fr: this.boat.type_fr, type_en: this.boat.type_en, displacements: this.boat.displacements, surface: this.boat.surface, engine_power: this.boat.engine_power, hull_fr: this.boat.hull_fr, hull_en: this.boat.hull_en, deck_fr: this.boat.deck_fr, deck_en: this.boat.deck_en, mast_fr: this.boat.mast_fr, mast_en: this.boat.mast_en, architect: this.boat.architect, diverse_fr: this.boat.diverse_fr, diverse_en: this.boat.diverse_en}
      // console.log(boatItem)
      await axiosClient.post('boat', boatItem, config)
      .then(res => {
        console.log(res)
        router.push(`/boat`)
      })
